  ...
  return (
    ...
    <div>
      ...
      <div>
        ...
        <div className="relative">
          <div className="absolute inset-y-0 left-0 pl-2 flex items-center pointer-events-none">
            <span className={`text-gray-400 ${compact ? 'text-xs' : 'text-sm'}`}>facebook.com/</span>
          </div>
          <Input
            id="facebook"
            ...
            maxLength={50}
            className={`${compact ? 'pl-[75px]' : 'pl-[90px]'} ${inputSize}`}
          />
        </div>
      </div>
      ...
      <div>
        ...
        <div className="relative">
          <div className="absolute inset-y-0 left-0 pl-2 flex items-center pointer-events-none">
            <span className={`text-gray-400 ${compact ? 'text-xs' : 'text-sm'}`}>instagram.com/</span>
          </div>
          <Input
            id="instagram"
            placeholder="nomdelapage"
            ...
            maxLength={50}
            className={`${compact ? 'pl-[80px]' : 'pl-[95px]'} ${inputSize}`}
          />
        </div>
      </div>

...
const SocialMediaInput = ({ id, domain, placeholder, value, onChange, maxLength = 50, primaryColor, compact = false }: SocialMediaInputProps) => (
  <div className={`flex items-center border border-input rounded-md bg-background overflow-hidden focus-within:ring-2 focus-within:ring-ring focus-within:ring-offset-2 ${compact ? 'text-sm' : 'text-sm'}`}>
    {/* Static domain part */}
    ...
    <div>
      ...
      <div>
        ...
        <SocialMediaInput
          ...
          onChange={(value) => onInputChange('facebook_url', value)}
          maxLength={50}
      ...
      <div>
        ...
        <SocialMediaInput
          ...
          onChange={(value) => onInputChange('instagram_url', value)}
          maxLength={50}
          primaryColor={primaryColor}
          compact={compact}
        />

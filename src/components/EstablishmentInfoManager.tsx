...
const SocialMediaInput = ({ id, domain, placeholder, value, onChange, maxLength = 50, primaryColor }: SocialMediaInputProps) => (
  <div className="flex items-center border border-input rounded-md bg-background text-sm overflow-hidden focus-within:ring-2 focus-within:ring-ring focus-within:ring-offset-2">
    {/* Static domain part */}
    <div className="px-3 py-2 bg-muted/50 border-r border-border text-muted-foreground font-medium whitespace-nowrap">
      {domain}
    </div>
    {/* Editable input part */}
    <input
      ...
      maxLength={maxLength}
      className="flex-1 px-3 py-2 bg-transparent outline-none placeholder:text-muted-foreground"
            ...
            <div>
              ...
              <div className="space-y-1">
                <Input
                  ...
                  maxLength={200}
                  className="text-sm"
                  style={primaryColor && formData.address ? { color: primaryColor } : {}}
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-1">
                <Input
                  ...
                  maxLength={20}
                  className="text-sm"
                  style={primaryColor && formData.phone ? { color: primaryColor } : {}}
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-1">
                <Input
                  ...
                  maxLength={255}
                  className="text-sm"
                  style={primaryColor && formData.email ? { color: primaryColor } : {}}
                />
              </div>
            </div>
